...
bool ConstantExp::DivideZero(EvalState &state){
    return false;
}

bool ConstantExp::isDefined(EvalState &state) {
    return true;
}
...
bool IdentifierExp::DivideZero(EvalState &state){
    return false;
}

bool IdentifierExp::isDefined(EvalState &state) {
    if (state.isDefined(name)) return true;
    return false;
}
...
bool CompoundExp::DivideZero(EvalState &state) {
    if (op != "/") {
        return false;
    } else {
        int right = rhs->eval(state);
...
bool CompoundExp::isDefined(EvalState &state) {
    if (lhs->isDefined(state) && rhs->isDefined(state)) return true;
    return false;
}